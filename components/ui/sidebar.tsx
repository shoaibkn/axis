...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      {/*<SidebarSimpleIcon size={32} color="#0085c8" weight="duotone" />*/}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        `bg-background md:peer-data-[variant=inset]:mr-2 md:peer-data-[variant=inset]:ml-0
          md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm
          md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-0 relative flex w-full flex-1 flex-col`,
        className,
      )}
      {...props}
    />
